...
# from utils import thread as thr
      ...
      if scores is None:
        ...
        if not skip_labels:
          if not agnostic_mode:
            ...
            #In line 676, we have introduced "y"
            #this is class_names going to X for try to not changing class name.
            #there is a loop for good, getting X(output class_name) and says with tts functions
            #else if there is no object it's n/a
            #after that x is equal to y and y is getting empty again in line 676.
            ...
            if classes[i] in category_index.keys():
              ...
              if x!=y:
                  ...
                  r1 = random.randint(1,1500000)
                  file1 = str("object" + str(r1) + ".mp3")
                  tts.save(file1)
